  ...
  return (
    <S.Footer>
      <FlexContainer wrap={'wrap'}>
        <S.SocialNetWorkWrap>
          <SectionTitle id={'contact'} color={theme.colors.text.light}>
              ...
              return (
                <S.SocialNetworkItem key={index}>
                  <S.SocialLink href={i.href} target={'_blank'}>
                    <Icon iconId={i.id} width={'24'} height={'24'} viewBox={'0 0 24 24'} />
                  </S.SocialLink>
                </S.SocialNetworkItem>
              );
            })}
              ...
              if (i.id !== 'clock') {
                return (
                  <S.ContactItem as={'a'} key={index} href={i.href} target="_blank">
                    <Icon iconId={i.id} width={'20'} height={'20'} viewBox={'0 0 20 20'} />
                    <Text weight={'600'} color={theme.colors.text.light}>
                      {i.text}
                    </Text>
                  </S.ContactItem>
                );
